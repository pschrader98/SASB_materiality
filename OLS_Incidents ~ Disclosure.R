...
est_11 <- feols(
  n_incidents_t1_log1p ~ overall_material_disclosure_log1p +
...
est_21 <- feols(
  n_incidents_t2_log1p ~ overall_material_disclosure_log1p +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_post2010,
  vcov = ~ cusip + YearQuarter
)
...
est_31 <- feols(
  n_incidents_t3_log1p ~ overall_material_disclosure_log1p +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_post2010,
  vcov = ~ cusip + YearQuarter
)
...
etable(
  ...
  file         = "./results/incidents_disclosure_words_ols.tex",
  replace      = TRUE,
  dict         = dict,
  digits       = "r3",
  digits.stats = "r3",
...
est_11 <- feols(
  n_car_5_material_year_t1_log1p ~ overall_material_disclosure_log1p +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_post2010,
  vcov = ~ cusip + YearQuarter
)
...
est_21 <- feols(
  n_car_5_material_year_t2_log1p ~ overall_material_disclosure_log1p +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_post2010,
  vcov = ~ cusip + YearQuarter
)
...
est_31 <- feols(
  n_car_5_material_year_t3_log1p ~ overall_material_disclosure_log1p +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_post2010,
  vcov = ~ cusip + YearQuarter
)
...
etable(
  ...
  file         = "./results/car_disclosure_words_ols.tex",
  replace      = TRUE,
  dict         = dict,
  digits       = "r3",
  digits.stats = "r3",
...
est_11 <- feols(
  n_reach_material_t1_log1p ~ overall_material_disclosure_log1p +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_post2010,
  vcov = ~ cusip + YearQuarter
)
...
est_21 <- feols(
  n_reach_material_t2_log1p ~ overall_material_disclosure_log1p +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_post2010,
  vcov = ~ cusip + YearQuarter
)
...
est_31 <- feols(
  n_reach_material_t3_log1p  ~ overall_material_disclosure_log1p +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_post2010,
  vcov = ~ cusip + YearQuarter
)
...
etable(
  ...
  file         = "./results/reach_disclosure_words_ols.tex",
  replace      = TRUE,
  dict         = dict,
  digits       = "r3",
  digits.stats = "r3",
