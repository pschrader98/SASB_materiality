...
est_11 <- fepois(
  n_incidents_t1 ~ overall_material_disclosure_log1p  +
...
est_21 <- fepois(
  n_incidents_t2 ~ overall_material_disclosure_log1p  +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_reprisk,
  vcov = ~ cusip + YearQuarter
)
...
est_31 <- fepois(
  n_incidents_t3 ~ overall_material_disclosure_log1p  +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_reprisk,
  vcov = ~ cusip + YearQuarter
)
...
etable(
  ...
  file         = "./results/incidents_disclosure_words.tex",
  replace      = TRUE,
  dict         = dict,
  digits       = "r3",
  digits.stats = "r3",
...
est_11 <- fepois(
  n_car_5_material_t1 ~ Material_manual_earnings_overall_share +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_reprisk,
  vcov = ~ cusip + YearQuarter
)
...
est_21 <- fepois(
  n_car_5_material_t2 ~ Material_manual_earnings_overall_share +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_reprisk,
  vcov = ~ cusip + YearQuarter
)
...
est_31 <- fepois(
  n_car_5_material_t3 ~ Material_manual_earnings_overall_share +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_reprisk,
  vcov = ~ cusip + YearQuarter
)
...
etable(
  ...
  file         = "./results/car_disclosure_words.tex",
  replace      = TRUE,
  dict         = dict,
  digits       = "r3",
  digits.stats = "r3",
...
est_11 <- fepois(
  n_reach_material_t1 ~ Material_manual_earnings_overall_share +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_reprisk, 
  vcov = ~ cusip + YearQuarter
)
...
est_21 <- fepois(
  n_reach_material_t2 ~ Material_manual_earnings_overall_share +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_reprisk,
  vcov = ~ cusip + YearQuarter
)
...
est_31 <- fepois(
  n_reach_material_t3 ~ Material_manual_earnings_overall_share +
    roa_abs_p1p99 + leverage_p1p99 + mtb_prevq_p1p99 + size_ln_mve_prevq,
  data = data_reprisk,
  vcov = ~ cusip + YearQuarter
)
...
etable(
  ...
  file         = "./results/reach_disclosure_words.tex",
  replace      = TRUE,
  dict         = dict,
  digits       = "r3",
  digits.stats = "r3",
